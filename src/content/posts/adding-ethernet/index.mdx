...
I didn't want to reloacate the WiFi extender either, as the only suitable locations for the home server would also just be too far away from the "pain points" of the house where I needed the relayed WiFi.
